...
new Resource("wood", 0, 100, 30, 50, "wood-work"),
new Resource("cart", 0, 25, 30, 100, "wood-work"), 
new Resource("furniture", 0, 5, 30, 30, "wood-work"),
new Resource("truss", 0, 2, 30, 40, "wood-work"),
new Resource("herbs", 0, 100, 30, 100, "medical"),
new Resource("medicine", 0, 1, 30, 20, "medical"),
new Resource("crop", 0, 1000, 30, 50, "food-products"),
new Resource("flour", 0, 300, 30, 100, "food-products"),
new Resource("bread", 100, 100, 30, 70, "food-products"),
new Resource("cake", 10, 50, 30, 100, "food-products"),
new Resource("beer", 100, 100, 30, 100, "food-products"),
new Resource("freshmeat", 0, 50, 30, 100, "food-products"),
new Resource("meat", 100, 50, 30, 200, "food-products"),
new Resource("cow", 0, 1, 300, 100, "animals"),
new Resource("leather", 0, 100, 30, 200, "leather-work"),
new Resource("harness", 0, 10, 30, 200, "leather-work"),
new Resource("shoe", 10, 5, 30, 250, "leather-work"),
new Resource("silk", 0, 20, 30, 50, "clothing"),
new Resource("dyedsilk", 0, 20, 30, 100, "clothing"),
new Resource("cloth", 0, 1, 30, 100, "clothing"),
new Resource("sheep", 0, 1, 30, 80, "animals"),
new Resource("wool", 0, 100, 30, 200, "clothing"),
new Resource("dyedwool", 0, 100, 30, 300, "clothing"),
new Resource("fabrik", 0, 10, 30, 200, "clothing"),
new Resource("clothes", 10, 100, 30, 500, "clothing"),
new Resource("iron", 0, 100, 30, 100, "iron-work"),
new Resource("tool", 0, 10, 30, 50, "iron-work"),
new Resource("stone", 0, 200, 30, 100, "stone-work"),
new Resource("brick", 0, 100, 30, 150, "stone-work"),
new Resource("tile", 0, 100, 30, 100, "stone-work"),
new Resource("sculpture", 0, 1, 30, 100, "stone-work"),
new Resource("gate", 0, 10, 30, 50, "iron-work"),
new Resource("weapon", 0, 10, 30, 150, "iron-work"),
new Resource("health", 200, 100, 30, 50, "no-market"),
new Resource("right", 500, 100, 30, 50, "no-market"),
];
